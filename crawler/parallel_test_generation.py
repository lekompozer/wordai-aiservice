#!/usr/bin/env python3
"""
Parallel Test Generation: Generate Online Tests for ALL Beginner Conversations

Purpose:
- Generate IELTS tests for all beginner conversations
...
RUN:
    python crawler/parallel_test_generation.py

PRODUCTION:
    docker exec -d ai-chatbot-rag python crawler/parallel_test_generation.py
...
async def main():
    """Generate tests for ALL beginner conversations in parallel batches"""
    print("=" * 80)
    print("🎓 PARALLEL TEST GENERATION - BEGINNER CONVERSATIONS")
    print("=" * 80)
    ...
    # Get beginner conversations WITHOUT tests
    conversations = list(
    ...
    print(f"📚 Found {total} beginner conversations without tests")
    print()

    if total == 0:
        print("✅ All beginner conversations already have tests!")
        return
    ...
    for i in range(0, total, BATCH_SIZE):
        ...
        tasks = [
            process_conversation(conv, "beginner", db_manager, xai_service, semaphore)
            for conv in batch
        ]
