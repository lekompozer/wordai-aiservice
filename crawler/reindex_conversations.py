...
def main():
    ...
    for topic_num in topics:
        ...
        convs = list(db.conversation_library.find(
    ...
    print("SUMMARY")
    print("=" * 80)
    print(f"Total conversations processed: {sum(db.conversation_library.count_documents({'topic_number': t}) for t in topics)}")
