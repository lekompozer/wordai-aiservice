...
def initialize_usdt_payment_db():
    ...
    try:
        ...
        usdt_payments.create_index("order_invoice_number", unique=True, name="idx_order_invoice")
        usdt_payments.create_index("user_id", name="idx_user_id")
        usdt_payments.create_index("transaction_hash", sparse=True, name="idx_transaction_hash")
        ...
        usdt_payments.create_index(
            [("payment_type", ASCENDING), ("status", ASCENDING)],
        ...
        usdt_pending.create_index("transaction_hash", unique=True, name="idx_transaction_hash")
