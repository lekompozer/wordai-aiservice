...
REPLACEMENTS = [
    ...
    ("from src.services.guide_chapter_manager", "from src.services.book_chapter_manager"),
    ("from src.services.guide_permission_manager", "from src.services.book_permission_manager"),
    ...
    ("from src.models.guide_permission_models", "from src.models.book_permission_models"),
