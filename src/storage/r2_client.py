...
class R2Client:
    ...
    def _upload_file_sync(self, local_path: str, remote_path: str):
    ...
    def _generate_presigned_url_sync(self, client_method: str, method_parameters: dict, expiration: int):
