...
# ==================== API 9: Create Module ====================
@router.post("/subjects/{subject_id}/modules", response_model=ModuleResponse, status_code=status.HTTP_201_CREATED)
...
@router.post("/modules/{module_id}/content", response_model=ModuleContentResponse, status_code=status.HTTP_201_CREATED)
...
@router.delete("/modules/{module_id}/content/{content_id}", status_code=status.HTTP_200_OK)
