"""
Test script to verify Claude 4.5 Sonnet on Vertex AI connection
...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = (
    "/Users/user/Code/wordai-aiservice/docs/wordai/Slide/wordai-6779e-ed6189c466f1.json"
)
...
try:
    ...
    if "429" in str(e) or "quota" in str(e).lower():
        ...
        print("   2. Search for: 'Claude 3.5 Sonnet'")
        print("   3. Request quota increase")
        print("   OR")
        print("   4. Use Anthropic API Key directly (fallback)")
